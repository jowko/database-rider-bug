...
public class EntityManagerProvider implements TestRule
{
    ...
    private static Map< String, EntityManagerProvider > providers = new ConcurrentHashMap<>();// one emf per
                                                                                              // unit
     ...
     *                                       properties to override persistence.xml props or define additions
     *                                       to them
     * @return EntityManagerProvider instance
     */
    @Deprecated
    // TODO: an existing instance will never be overridden if the props have changed. Must be removed. Use
    // newInstance instead.
    public static synchronized EntityManagerProvider instance( String unitName,
    ...
    /**
     * @param unitName
     *                     unit name clear entities on underlying context
     * @return a clean EntityManagerProvider
     */
    public static synchronized EntityManagerProvider newInstance( String unitName )
    {
    ...
    private void init( String unitName, Map< String, Object > props ) throws SQLException
    {
        if( emf == null )
        {
            ...
            emf = dbConfig == null ? Persistence.createEntityManagerFactory( unitName )
    ...
    private Connection createConnection( EntityManager em ) throws SQLException
    {
        ...
        else
        {
            /**
             * see
             * here:http://wiki.eclipse.org/EclipseLink/Examples/JPA/EMAPI#Getting_a_JDBC_Connection_from_an_EntityManager
             */
            tx.begin();
    ...
    /**
     * @param puName
     *                   unit name clears entityManager persistence context and entityManager factory cache
     *                   represented by given puName
    ...
    /**
     * clears entityManager persistence context and entity manager factory cache of current instance of this
     * provider
     *
